...
# mkdir $TMPDIR/datasets/dataset_complete
...
python model_snow_segmentation.py --batch_size 8 --lr 0.00001 --epochs 100 --train_split 0.8 --path_dset /cluster/scratch/jbaumer/datasets/dataset_complete/ --optim SGD --lr_scheduler 7 --weight_decay 0.1 --momentum 0.9 --stations \[\'Buelenberg_1\'\]
