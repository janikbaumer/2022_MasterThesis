...
python model_fog_classification.py  --batch_size 8 --lr 0.0001 --epochs 100 --train_split 0.8 --path_dset /cluster/scratch/jbaumer/datasets/dataset_downsampled/ --weighted Auto --model resnet --optim SGD --lr_scheduler 15 --weight_decay 0.1 --momentum 0.9  --stations "['Luksch_1']"
